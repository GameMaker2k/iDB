...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/09/2007 SVN 73 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 73; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 08; $SVNDay[1] = 09; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
