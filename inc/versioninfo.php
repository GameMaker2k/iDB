...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 7/21/2009 SVN 276 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 276; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 7; $SVNDay[1] = 21; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
