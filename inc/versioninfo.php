...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/08/2011 SVN 745 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 745;
$SVNDay[0] = 08; $SVNDay[1] = 08; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
