...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 6/16/2021 SVN 934 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 934; $GitRevN = "$Id$";
$SVNDay[0] = 6; $SVNDay[1] = 16; $SVNDay[2] = 2021; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
