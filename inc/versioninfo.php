...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/03/2011 SVN 647 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 647;
$SVNDay[0] = 05; $SVNDay[1] = 03; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
