...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/25/2019 SVN 918 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 918; $GitRevN = "$Id$";
$SVNDay[0] = 11; $SVNDay[1] = 25; $SVNDay[2] = 2020; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
