...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 9/21/2023 SVN 1004 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1004; $GitRevN = '$Id$';
$SVNDay[0] = 9; $SVNDay[1] = 21; $SVNDay[2] = 2023; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
