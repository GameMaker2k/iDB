...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 9/24/2024 SVN 1229 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 7; $VER1[2] = 0; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1229; $GitRevPreN = '$Id$';
