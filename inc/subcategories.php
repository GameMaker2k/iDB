...
/*
    ...
    $FileInfo: subcategories.php - Last Update: 07/18/2011 SVN 720 - Author: cooldude2k $
*/
...
$TimeStamp=GMTimeChange("F j Y, ".$Settings['idb_time_format'],$TimeStamp,$_SESSION['UserTimeZone'],0,$_SESSION['UserDST']);
