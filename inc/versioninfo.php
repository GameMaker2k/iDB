...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 12/29/2012 SVN 776 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 776;
$SVNDay[0] = 12; $SVNDay[1] = 29; $SVNDay[2] = 2012; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
