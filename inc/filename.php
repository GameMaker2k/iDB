...
/*
    ...
    $FileInfo: filename.php - Last Update: 06/07/2007 SVN 20 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 20; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 6; $SVNDay[1] = 07; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
