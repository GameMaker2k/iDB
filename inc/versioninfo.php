...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/15/2014 SVN 789 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 789;
$SVNDay[0] = 07; $SVNDay[1] = 15; $SVNDay[2] = 2014; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
