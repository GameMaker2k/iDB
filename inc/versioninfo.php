...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 06/23/2019 SVN 897 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 5; $VER1[2] = 0; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 897;
$SVNDay[0] = 6; $SVNDay[1] = 23; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
