...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 03/18/2010 SVN 459 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 459; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 03; $SVNDay[1] = 18; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
