...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 12/17/2010 SVN 604 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 604; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 12; $SVNDay[1] = 17; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
