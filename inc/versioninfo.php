...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 01/04/2011 SVN 609 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 609; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 01; $SVNDay[1] = 04; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
