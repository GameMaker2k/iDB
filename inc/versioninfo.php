...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/27/2020 SVN 928 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 5; $VER1[2] = 3; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 928; $GitRevN = "$Id: fa5727a341e635d96e1b36e6a40c019358ed404b $";
$SVNDay[0] = 11; $SVNDay[1] = 27; $SVNDay[2] = 2020; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
