...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 09/26/2008 SVN 172 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 172; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 09; $SVNDay[1] = 26; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
