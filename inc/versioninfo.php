...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 06/06/2010 SVN 518 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 518; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 06; $SVNDay[1] = 06; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
