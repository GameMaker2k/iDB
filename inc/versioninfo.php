...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 2/14/2008 SVN 231 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 231; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 2; $SVNDay[1] = 14; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
