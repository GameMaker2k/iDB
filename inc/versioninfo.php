...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/12/2015 SVN 794 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 794;
$SVNDay[0] = 8; $SVNDay[1] = 12; $SVNDay[2] = 2015; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
