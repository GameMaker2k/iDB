...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/26/2011 SVN 659 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 659;
$SVNDay[0] = 05; $SVNDay[1] = 26; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
