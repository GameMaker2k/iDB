...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 09/04/2010 SVN 568 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 568; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 09; $SVNDay[1] = 04; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
...
// Uncomment next two lines to get rid of version info headers
//header("X-Powered-By: ");
//header("Generator: ");
?>
