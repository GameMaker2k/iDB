...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 4/13/2022 SVN 964 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 964; $GitRevN = '$Id$';
$SVNDay[0] = 4; $SVNDay[1] = 13; $SVNDay[2] = 2022; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
