...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 02/20/2010 SVN 457 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 457; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 02; $SVNDay[1] = 20; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
