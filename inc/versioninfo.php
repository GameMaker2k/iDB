...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 4/4/2022 SVN 943 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 5; $VER1[2] = 5; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 943; $GitRevN = "$Id$";
$SVNDay[0] = 4; $SVNDay[1] = 4; $SVNDay[2] = 2022; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
