...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 8/21/2024 SVN 1014 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1014; $GitRevN = '$Id:$';
$SVNDay[0] = 8; $SVNDay[1] = 21; $SVNDay[2] = 2024; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
