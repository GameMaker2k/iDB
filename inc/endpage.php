...
/*
    ...
    $FileInfo: endpage.php - Last Update: 08/06/2011 SVN 743 - Author: cooldude2k $
*/
...
$MyFullTimeNow = GMTimeGet($Settings['idb_date_format'].", ".$Settings['idb_time_format'],$_SESSION['UserTimeZone'],0,$_SESSION['UserDST']);
