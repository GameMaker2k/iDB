...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 06/30/2011 SVN 689 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 689;
$SVNDay[0] = 06; $SVNDay[1] = 30; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
