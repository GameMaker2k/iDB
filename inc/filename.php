...
/*
    ...
    $FileInfo: filename.php - Last Update: 05/12/2007 SVN 3 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 3; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 5; $SVNDay[1] = 12; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
