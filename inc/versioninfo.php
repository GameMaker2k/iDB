...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/13/2007 SVN 78 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 78; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 08; $SVNDay[1] = 13; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
