...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/23/2011 SVN 655 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 655;
$SVNDay[0] = 05; $SVNDay[1] = 23; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
