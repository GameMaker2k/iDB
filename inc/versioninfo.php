...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/26/2009 SVN 366 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 366; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 11; $SVNDay[1] = 26; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
