...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 03/31/2019 SVN 885 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 885;
$SVNDay[0] = 3; $SVNDay[1] = 31; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
