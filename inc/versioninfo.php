...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/20/2007 SVN 50 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 50; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 07; $SVNDay[1] = 20; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
