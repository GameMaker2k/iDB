...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 2/28/2009 SVN 235 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 235; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 2; $SVNDay[1] = 28; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
