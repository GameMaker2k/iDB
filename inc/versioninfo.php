...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 02/19/2011 SVN 621 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 621;
$SVNDay[0] = 02; $SVNDay[1] = 19; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
