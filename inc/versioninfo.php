...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/07/2009 SVN 323 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 323; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 10; $SVNDay[1] = 07; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
