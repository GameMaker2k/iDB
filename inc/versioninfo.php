...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 8/30/2024 SVN 1076 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1076; $GitRevPreN = '$Id$';
$GitRevN = getGitRevision($GitRevPreN);
$SVNDay[0] = 8; $SVNDay[1] = 30; $SVNDay[2] = 2024; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
