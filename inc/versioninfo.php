...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 09/10/2015 SVN 801 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 802;
$SVNDay[0] = 9; $SVNDay[1] = 10; $SVNDay[2] = 2015; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
