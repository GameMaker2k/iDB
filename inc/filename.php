...
/*
    ...
    $FileInfo: filename.php - Last Update: 06/14/2007 SVN 23 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 23; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 06; $SVNDay[1] = 14; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
