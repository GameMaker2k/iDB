...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 03/12/2008 SVN 153 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 153; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 03; $SVNDay[1] = 12; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
