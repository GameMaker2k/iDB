...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 02/18/2008 SVN 150 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 150; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 02; $SVNDay[1] = 18; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
