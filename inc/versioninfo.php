...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 3/29/2009 SVN 242 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 242; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 3; $SVNDay[1] = 29; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
