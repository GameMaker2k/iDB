...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 9/1/2024 SVN 1090 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1090; $GitRevPreN = '$Id: ee4ec4ce953228c47ed6e936fa87f42005f4fef9 $';
$GitRevN = getGitRevision($GitRevPreN);
$SVNDay[0] = 9; $SVNDay[1] = 1; $SVNDay[2] = 2024; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
