...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 09/18/2010 SVN 552 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 552; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 09; $SVNDay[1] = 18; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
