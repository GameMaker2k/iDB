...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/21/2010 SVN 495 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 3; $VER1[2] = 9; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 495; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 05; $SVNDay[1] = 21; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
