...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/15/2007 SVN 128 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 128; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 11; $SVNDay[1] = 15; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
