...
/*
    ...
    $FileInfo: subforum.php - Last Update: 06/07/2007 SVN 20 - Author: cooldude2k $
*/
...
<?php change_title($Settings['board_name']." ".$ThemeSet['TitleDivider']." Viewing SubForum ".$ForumName,$Settings['use_gzip'],$GZipEncode['Type']); ?>
