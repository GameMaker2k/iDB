...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/05/2009 SVN 322 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 322; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 10; $SVNDay[1] = 05; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
