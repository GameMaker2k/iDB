...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 06/07/2008 SVN 166 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 166; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 06; $SVNDay[1] = 07; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
