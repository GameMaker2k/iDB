...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/23/2007 SVN 119 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 119; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 10; $SVNDay[1] = 23; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
