...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 9/16/2009 SVN 320 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 320; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 9; $SVNDay[1] = 16; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
