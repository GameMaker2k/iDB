...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/22/2010 SVN 498 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 498; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 05; $SVNDay[1] = 22; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
