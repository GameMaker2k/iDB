...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 1/11/2008 SVN 226 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 226; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 1; $SVNDay[1] = 11; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
