...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/30/2011 SVN 729 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 729;
$SVNDay[0] = 07; $SVNDay[1] = 30; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
