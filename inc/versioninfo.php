...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 6/27/2023 SVN 993 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 993; $GitRevN = '$Id$';
$SVNDay[0] = 6; $SVNDay[1] = 27; $SVNDay[2] = 2023; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
