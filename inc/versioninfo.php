...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 4/10/2022 SVN 961 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 961; $GitRevN = '$Id:$';
$SVNDay[0] = 4; $SVNDay[1] = 10; $SVNDay[2] = 2022; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
