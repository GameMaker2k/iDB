...
gzip_page($Settings['use_gzip'],$GZipEncode['Type']); session_write_close(); die(); }*/
$ForumIgnoreList1 = null;
$ForumIgnoreList2 = null;
$ForumIgnoreList3 = null;
$ForumIgnoreList4 = null;
$ForumIgnoreList5 = null;
$ForumIgnoreList6 = null;
$ModForumIgnoreList1 = null;
$ModForumIgnoreList2 = null;
$ModForumIgnoreList3 = null;
$ModForumIgnoreList4 = null;
if ($pernum >= 1) {
    while ($peri < $pernum) {
        ...
        if ($PermissionInfo['CanViewForum'][$PerForumID] == "no") {
            if (strlen($ForumIgnoreList1) > 1) {
                $ForumIgnoreList1 .= " AND \"id\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList1) < 1) {
                $ForumIgnoreList1 = " \"id\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList2) > 1) {
                $ForumIgnoreList2 .= " AND \"id\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList2) < 1) {
                $ForumIgnoreList2 = " AND \"id\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList3) > 1) {
                $ForumIgnoreList3 .= " AND \"ForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList3) < 1) {
                $ForumIgnoreList3 = " WHERE \"ForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList4) > 1) {
                $ForumIgnoreList4 .= " AND \"ForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList4) < 1) {
                $ForumIgnoreList4 = " AND \"ForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList5) > 1) {
                $ForumIgnoreList5 .= " AND \"OldForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList5) < 1) {
                $ForumIgnoreList5 = " WHERE \"OldForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList6) > 1) {
                $ForumIgnoreList6 .= " AND \"OldForumID\"<>".$PerForumID;
            }
            if (strlen($ForumIgnoreList6) < 1) {
                $ForumIgnoreList6 = " AND \"OldForumID\"<>".$PerForumID;
            }
        ...
        if ($PermissionInfo['CanModForum'][$PerForumID] == "no") {
            if (isset($ModForumIgnoreList1)) {
                if (strlen($ModForumIgnoreList1) > 1) {
                    $ModForumIgnoreList1 .= " AND \"id\"<>".$PerForumID;
                }
                if (strlen($ModForumIgnoreList1) < 1) {
                    $ModForumIgnoreList1 = " \"id\"<>".$PerForumID;
                }
            }
            if (isset($ModForumIgnoreList2)) {
                if (strlen($ModForumIgnoreList2) > 1) {
                    $ModForumIgnoreList2 .= " AND \"id\"<>".$PerForumID;
                }
                if (strlen($ModForumIgnoreList2) < 1) {
                    $ModForumIgnoreList2 = " AND \"id\"<>".$PerForumID;
                }
            ...
            if (isset($ModForumIgnoreList3)) {
                if (strlen($ModForumIgnoreList3) > 1) {
                    $ModForumIgnoreList3 .= " AND \"ForumID\"<>".$PerForumID;
                }
                if (strlen($ModForumIgnoreList3) < 1) {
                    $ModForumIgnoreList3 = " WHERE \"ForumID\"<>".$PerForumID;
                }
            }
            if (isset($ModForumIgnoreList4)) {
                if (strlen($ModForumIgnoreList4) > 1) {
                    $ModForumIgnoreList4 .= " AND \"ForumID\"<>".$PerForumID;
                }
                if (strlen($ModForumIgnoreList4) < 1) {
                    $ModForumIgnoreList4 = " AND \"ForumID\"<>".$PerForumID;
                }
...
if ($per2num >= 1) {
    while ($per2i < $per2num) {
        ...
        if ($CatPermissionInfo['CanViewCategory'][$PerCatID] == "no") {
            ...
            if (strlen($CatIgnoreList3) > 1) {
                $CatIgnoreList3 .= " AND \"CategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList3) < 1) {
                $CatIgnoreList3 = " WHERE \"CategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList4) > 1) {
                $CatIgnoreList4 .= " AND \"CategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList4) < 1) {
                $CatIgnoreList4 = " AND \"CategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList5) > 1) {
                $CatIgnoreList5 .= " AND \"OldCategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList5) < 1) {
                $CatIgnoreList5 = " WHERE \"OldCategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList6) > 1) {
                $CatIgnoreList6 .= " AND \"OldCategoryID\"<>".$PerCatID;
            }
            if (strlen($CatIgnoreList6) < 1) {
                $CatIgnoreList6 = " AND \"OldCategoryID\"<>".$PerCatID;
            }
