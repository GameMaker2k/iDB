...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 8/26/2024 SVN 1033 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 6; $VER1[2] = 4; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1033; $GitRevN = '$Id$';
function getGitRevision($GitRevN) {
    // Use a regular expression to extract the revision number
    if (preg_match('/\$Id$/', $GitRevN, $matches)) {
        return $matches[1];
    }
    return null; // Return null if no match is found
}
$SVNDay[0] = 8; $SVNDay[1] = 26; $SVNDay[2] = 2024; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
