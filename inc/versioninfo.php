...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 6/25/2023 SVN 990 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 6; $VER1[2] = 2; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 990; $GitRevN = '$Id$';
$SVNDay[0] = 6; $SVNDay[1] = 25; $SVNDay[2] = 2023; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
