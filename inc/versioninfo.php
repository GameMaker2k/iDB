...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 4/6/2022 SVN 946 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 946; $GitRevN = '$Id$';
$SVNDay[0] = 4; $SVNDay[1] = 6; $SVNDay[2] = 2022; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
