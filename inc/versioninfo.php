...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/05/2019 SVN 906 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 906;
$SVNDay[0] = 8; $SVNDay[1] = 5; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
