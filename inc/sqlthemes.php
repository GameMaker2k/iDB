...
if ($ThemeSet['ThemeMaker'] == "") {
    $ThemeSet['ThemeMaker'] = null;
}
$ThemeSet['ThemeVersion'] = $themeresult_array['ThemeVersion'];
if ($ThemeSet['ThemeVersion'] == "") {
    $ThemeSet['ThemeVersion'] = null;
}
$ThemeSet['ThemeVersionType'] = $themeresult_array['ThemeVersionType'];
if ($ThemeSet['ThemeVersionType'] == "") {
    $ThemeSet['ThemeVersionType'] = null;
}
$ThemeSet['ThemeSubVersion'] = $themeresult_array['ThemeSubVersion'];
if ($ThemeSet['ThemeSubVersion'] == "") {
    $ThemeSet['ThemeSubVersion'] = null;
}
$ThemeSet['MakerURL'] = $themeresult_array['MakerURL'];
if ($ThemeSet['MakerURL'] == "") {
    $ThemeSet['MakerURL'] = null;
}
$ThemeSet['CopyRight'] = $themeresult_array['CopyRight'];
if ($ThemeSet['CopyRight'] == "") {
    $ThemeSet['CopyRight'] = null;
}
$ThemeSet['WrapperString'] = $themeresult_array['WrapperString'];
if ($ThemeSet['WrapperString'] == "") {
    $ThemeSet['WrapperString'] = null;
}
...
if ($ThemeSet['LogoStyle'] == "") {
    $ThemeSet['LogoStyle'] = null;
}
...
if ($ThemeSet['TopicIcon'] == "") {
    $ThemeSet['TopicIcon'] = null;
}
$ThemeSet['MovedTopicIcon'] = $themeresult_array['MovedTopicIcon'];
if ($ThemeSet['MovedTopicIcon'] == "") {
    $ThemeSet['MovedTopicIcon'] = $ThemeSet['TopicIcon'];
}
$ThemeSet['HotTopic'] = $themeresult_array['HotTopic'];
if ($ThemeSet['HotTopic'] == "") {
    $ThemeSet['HotTopic'] = null;
}
$ThemeSet['MovedHotTopic'] = $themeresult_array['MovedHotTopic'];
if ($ThemeSet['MovedHotTopic'] == "") {
    $ThemeSet['MovedHotTopic'] = $ThemeSet['HotTopic'];
}
$ThemeSet['PinTopic'] = $themeresult_array['PinTopic'];
if ($ThemeSet['PinTopic'] == "") {
    $ThemeSet['PinTopic'] = null;
}
$ThemeSet['AnnouncementTopic'] = $themeresult_array['AnnouncementTopic'];
if ($ThemeSet['AnnouncementTopic'] == "") {
    $ThemeSet['AnnouncementTopic'] = $ThemeSet['PinTopic'];
}
$ThemeSet['MovedPinTopic'] = $themeresult_array['MovedPinTopic'];
if ($ThemeSet['MovedPinTopic'] == "") {
    $ThemeSet['MovedPinTopic'] = $ThemeSet['PinTopic'];
}
$ThemeSet['HotPinTopic'] = $themeresult_array['HotPinTopic'];
if ($ThemeSet['HotPinTopic'] == "") {
    $ThemeSet['HotPinTopic'] = null;
}
$ThemeSet['MovedHotPinTopic'] = $themeresult_array['MovedHotPinTopic'];
if ($ThemeSet['MovedHotPinTopic'] == "") {
    $ThemeSet['MovedHotPinTopic'] = $ThemeSet['HotPinTopic'];
}
$ThemeSet['ClosedTopic'] = $themeresult_array['ClosedTopic'];
if ($ThemeSet['ClosedTopic'] == "") {
    $ThemeSet['ClosedTopic'] = null;
}
$ThemeSet['MovedClosedTopic'] = $themeresult_array['MovedClosedTopic'];
if ($ThemeSet['MovedClosedTopic'] == "") {
    $ThemeSet['MovedClosedTopic'] = $ThemeSet['ClosedTopic'];
}
$ThemeSet['HotClosedTopic'] = $themeresult_array['HotClosedTopic'];
if ($ThemeSet['HotClosedTopic'] == "") {
    $ThemeSet['HotClosedTopic'] = null;
}
$ThemeSet['MovedHotClosedTopic'] = $themeresult_array['MovedHotClosedTopic'];
if ($ThemeSet['MovedHotClosedTopic'] == "") {
    $ThemeSet['MovedHotClosedTopic'] = $ThemeSet['HotClosedTopic'];
}
$ThemeSet['PinClosedTopic'] = $themeresult_array['PinClosedTopic'];
if ($ThemeSet['PinClosedTopic'] == "") {
    $ThemeSet['PinClosedTopic'] = null;
}
$ThemeSet['MovedPinClosedTopic'] = $themeresult_array['MovedPinClosedTopic'];
if ($ThemeSet['MovedPinClosedTopic'] == "") {
    $ThemeSet['MovedPinClosedTopic'] = $ThemeSet['PinClosedTopic'];
}
$ThemeSet['HotPinClosedTopic'] = $themeresult_array['HotPinClosedTopic'];
if ($ThemeSet['HotPinClosedTopic'] == "") {
    $ThemeSet['HotPinClosedTopic'] = null;
}
$ThemeSet['MovedHotPinClosedTopic'] = $themeresult_array['MovedHotPinClosedTopic'];
if ($ThemeSet['MovedHotPinClosedTopic'] == "") {
    $ThemeSet['MovedHotPinClosedTopic'] = $ThemeSet['HotPinClosedTopic'];
}
$ThemeSet['MessageRead'] = $themeresult_array['MessageRead'];
if ($ThemeSet['MessageRead'] == "") {
    $ThemeSet['MessageRead'] = null;
}
$ThemeSet['MessageUnread'] = $themeresult_array['MessageUnread'];
if ($ThemeSet['MessageUnread'] == "") {
    $ThemeSet['MessageUnread'] = null;
}
$ThemeSet['Profile'] = $themeresult_array['Profile'];
if ($ThemeSet['Profile'] == "") {
    $ThemeSet['Profile'] = null;
}
