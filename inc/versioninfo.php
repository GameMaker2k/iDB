...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 5/31/2021 SVN 931 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 931; $GitRevN = "$Id$";
$SVNDay[0] = 5; $SVNDay[1] = 31; $SVNDay[2] = 2021; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
