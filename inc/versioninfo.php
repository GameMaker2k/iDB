...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 12/15/2009 SVN 407 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 407; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 12; $SVNDay[1] = 15; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
