...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 7/15/2023 SVN 1001 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1001; $GitRevN = '$Id$';
$SVNDay[0] = 7; $SVNDay[1] = 15; $SVNDay[2] = 2023; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
