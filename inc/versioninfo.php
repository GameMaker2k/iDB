...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 8/20/2009 SVN 314 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 314; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 8; $SVNDay[1] = 20; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
