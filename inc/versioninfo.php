...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/22/2007 SVN 89 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 89; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 08; $SVNDay[1] = 22; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
