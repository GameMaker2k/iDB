...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/24/2011 SVN 763 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 763;
$SVNDay[0] = 10; $SVNDay[1] = 24; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
