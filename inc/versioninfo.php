...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/01/2010 SVN 528 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 528; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 07; $SVNDay[1] = 01; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
