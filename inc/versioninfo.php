...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 03/31/2008 SVN 157 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 157; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 03; $SVNDay[1] = 31; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
