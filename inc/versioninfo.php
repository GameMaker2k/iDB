...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 9/23/2024 SVN 1223 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 1223; $GitRevPreN = '$Id$';
$GitRevN = getGitRevision($GitRevPreN);
$SVNDay[0] = 9; $SVNDay[1] = 23; $SVNDay[2] = 2024; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
