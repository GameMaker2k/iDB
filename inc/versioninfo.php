...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 4/15/2022 SVN 969 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 969; $GitRevN = '$Id$';
$SVNDay[0] = 4; $SVNDay[1] = 15; $SVNDay[2] = 2022; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
