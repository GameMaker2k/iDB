...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 5/01/2009 SVN 247 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 247; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 5; $SVNDay[1] = 01; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
