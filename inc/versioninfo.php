...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/31/2019 SVN 903 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 5; $VER1[2] = 1; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 903;
