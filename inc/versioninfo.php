...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/04/2018 SVN 881 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 881;
$SVNDay[0] = 10; $SVNDay[1] = 4; $SVNDay[2] = 2018; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
