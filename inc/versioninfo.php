...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 08/10/2011 SVN 747 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 747;
$SVNDay[0] = 08; $SVNDay[1] = 10; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
