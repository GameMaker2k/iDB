...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 06/21/2019 SVN 891 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 891;
$SVNDay[0] = 6; $SVNDay[1] = 21; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
