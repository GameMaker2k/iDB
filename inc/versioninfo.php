...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/25/2007 SVN 53 - Author: cooldude2k $
*/
...
$VER1[0] = 0; $VER1[1] = 1; $VER1[2] = 6; $VERFull[1] = $VER1[0].".".$VER1[1].".".$VER1[2];
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 53; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 07; $SVNDay[1] = 25; $SVNDay[2] = 2007; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
