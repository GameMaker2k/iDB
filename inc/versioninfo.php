...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 8/11/2009 SVN 304 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 303; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 8; $SVNDay[1] = 11; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
