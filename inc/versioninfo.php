...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 04/27/2010 SVN 470 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 470; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 04; $SVNDay[1] = 27; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
