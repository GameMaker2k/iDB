...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/18/2008 SVN 191 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 191; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 11; $SVNDay[1] = 18; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
