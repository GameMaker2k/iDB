...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/13/2011 SVN 709 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 709;
$SVNDay[0] = 07; $SVNDay[1] = 13; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
