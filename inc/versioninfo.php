...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/30/2019 SVN 901 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 901;
$SVNDay[0] = 7; $SVNDay[1] = 30; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
