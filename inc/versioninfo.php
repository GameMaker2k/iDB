...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 2/24/2008 SVN 234 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 234; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 2; $SVNDay[1] = 24; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
