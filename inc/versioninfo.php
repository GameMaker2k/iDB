...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 02/25/2011 SVN 623 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 623;
$SVNDay[0] = 02; $SVNDay[1] = 25; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
