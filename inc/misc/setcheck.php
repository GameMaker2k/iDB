...
/*
    ...
    $FileInfo: setcheck.php - Last Update: 8/23/2024 SVN 1023 - Author: cooldude2k $
*/
...
if (!is_array($GZipEncode)) {
    $GZipEncode = array("Type" => "none");
}
if (!isset($preact)) {
    $preact = null;
}
if (!isset($Settings['hash_type'])) {
    $Settings['hash_type'] = null;
}
if (!isset($Error)) {
    $Error = null;
}
...
if ($Settings['DefaultTheme'] != null) {
    if (file_exists("themes/".$Settings['DefaultTheme']."/settings.php")) {
        ...
        $Settings['DefaultTheme'] = $FallBack['DefaultTheme'];
...
if ($_GET['act'] == null && $_GET['action'] != null) {
    $_GET['act'] = $_GET['action'];
}
if ($_GET['act'] == null && $_GET['activity'] != null) {
    $_GET['act'] = $_GET['activity'];
}
if ($_GET['act'] == null && $_GET['function'] != null) {
    $_GET['act'] = $_GET['function'];
}
if ($_GET['act'] == null && $_GET['mode'] != null) {
    $_GET['act'] = $_GET['mode'];
}
if ($_GET['act'] == null && $_GET['show'] != null) {
    $_GET['act'] = $_GET['show'];
}
if ($_GET['act'] == null && $_GET['do'] != null) {
    $_GET['act'] = $_GET['do'];
}
if ($_GET['act'] == "idx" || $_GET['act'] == "View") {
    $_GET['act'] = "view";
}
if ($_GET['act'] == "Lo-Fi" || $_GET['act'] == "lo-fi") {
    $_GET['act'] = "lowview";
}
if ($_GET['act'] == "Low-View" || $_GET['act'] == "low-view") {
    $_GET['act'] = "lowview";
}
if ($_GET['act'] == "LowView" || $_GET['act'] == "loview") {
    $_GET['act'] = "lowview";
}
if ($_GET['act'] == "iDBInfo") {
