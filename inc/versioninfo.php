...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 09/13/2018 SVN 877 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 877;
$SVNDay[0] = 9; $SVNDay[1] = 13; $SVNDay[2] = 2018; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
