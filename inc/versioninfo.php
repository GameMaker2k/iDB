...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/27/2008 SVN 184 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 184; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 10; $SVNDay[1] = 27; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
