...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 02/12/2008 SVN 147 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 147; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 02; $SVNDay[1] = 12; $SVNDay[2] = 2008; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
