...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 10/02/2009 SVN 321 - Author: cooldude2k $
*/
...
$VER2[0] = "Pre-Alpha"; $VER2[1] = "PA"; $VER2[2] = "SVN"; $SubVerN = 321; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 10; $SVNDay[1] = 02; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
