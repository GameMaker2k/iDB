...
/*
    ...
    $FileInfo: subcategories.php - Last Update: 08/06/2011 SVN 743 - Author: cooldude2k $
*/
...
$TimeStamp=GMTimeChange($Settings['idb_date_format'].", ".$Settings['idb_time_format'],$TimeStamp,$_SESSION['UserTimeZone'],0,$_SESSION['UserDST']);
