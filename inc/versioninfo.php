...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 05/28/2010 SVN 503 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 503; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 05; $SVNDay[1] = 28; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
