...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 11/20/2011 SVN 774 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 774;
$SVNDay[0] = 11; $SVNDay[1] = 20; $SVNDay[2] = 2011; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
