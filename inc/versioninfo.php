...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 07/31/2019 SVN 902 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 902;
$SVNDay[0] = 7; $SVNDay[1] = 31; $SVNDay[2] = 2019; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
