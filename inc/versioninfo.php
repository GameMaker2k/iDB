...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 12/19/2009 SVN 430 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 430; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 12; $SVNDay[1] = 19; $SVNDay[2] = 2009; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
