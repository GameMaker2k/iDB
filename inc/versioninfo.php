...
/*
    ...
    $FileInfo: versioninfo.php - Last Update: 04/30/2010 SVN 475 - Author: cooldude2k $
*/
...
$VER2[0] = "Alpha"; $VER2[1] = "Al"; $VER2[2] = "SVN"; $SubVerN = 475; $RName = "iDB"; $SFName = "IntDB";
$SVNDay[0] = 04; $SVNDay[1] = 30; $SVNDay[2] = 2010; $SVNDay[3] = $SVNDay[0]."/".$SVNDay[1]."/".$SVNDay[2];
